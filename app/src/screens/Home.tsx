...
const GaugeIcon = () => (
  ...
  >
    ...
    <polyline points="16 8 12 12 14 14" />
  </svg>
);
const SendIcon = () => (
  <svg
    ...
    <div className="home">
      ...
      <section className="home-features" id="product">
        <article className="home-feature">
          ...
          <p>
            {" "}
            Turn cold prospects into qualified opportunities with AI-powered prospecting, personalized outreach,
            automated follow-ups, and intelligent lead qualification.
          </p>
          <div className="home-feature-foot">
            <span className="by">
              <span className="dot">S</span> Shorty Harris
            </span>
            <span>★ 4.9</span>
          </div>
        </article>
        ...
        <article className="home-feature">
          ...
          <div className="home-feature-by">by Shorty Harris</div>
          <p>
            Automatically score leads 0–100 based on buying signals and engagement. Identify your hottest prospects in
            seconds.
          </p>
          <div className="home-feature-foot">
            <span className="by">
        ...
        <article className="home-feature">
          ...
          <div className="home-feature-by">by Shorty Harris</div>
          <p>
            AI-powered multi-channel messaging tailored to each prospect. Email, SMS, and WhatsApp automation in one
            platform.
          </p>
          <div className="home-feature-foot">
            <span className="by">
