...
/* ── Tag input — type + Enter (or the separator key, or clicking away)
   adds removable chips. `splitOn` also lets a single paste/typed string
   like "restaurants, cafes, hotels" become three chips at once. ───── */
function TagInput({
